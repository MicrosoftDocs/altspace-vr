---
title: AltspaceVR software license terms
description: Microsoft software license terms - AltspaceVR
ms.date: 4/11/2022
ms.topic: article
keywords: terms of service
---

# MICROSOFT SOFTWARE LICENSE TERMS - ALTSPACEVR 
...
1. **INSTALLATION AND USE RIGHTS.**
    ...
    1. **Microsoft Services Agreement.** Some features of the software provide access to, or rely on, online services. The use of those services (but not the software) is governed by the separate terms and privacy policies in the Microsoft Services Agreement at <https://go.microsoft.com/fwlink/?linkid=398923>. Please read them. The services may not be available in all regions. 
...
1. **DATA.**
    ...
    1. **Processing of Personal Data.** To the extent Microsoft is a processor or subprocessor of personal data in connection with the software, Microsoft makes the commitments in the European Union General Data Protection Regulation Terms of the Online Services Terms to all customers effective May 25, 2018, at [Microsoft’s GDPR Commitments to Customers of our Generally Available Enterprise Software Products](/legal/gdpr).
...
1. **SCOPE OF LICENSE.** The software is licensed, not sold. Microsoft reserves all other rights. Unless applicable law gives you more rights despite this limitation, you will not (and have no right to):
    ...
    1. use the software for commercial, non-profit, or revenue-generating activities unless you have commercial use rights under a separate agreement;
...
1. **CODE OF CONDUCT.** By agreeing to these license terms, you’re agreeing that, when using the software, you will follow these rules:

    1. Don’t do anything illegal.

    1. Don’t engage in any activity that exploits, harms, or threatens to harm children.  

    1. Don’t send spam. Spam is unwanted or unsolicited bulk email, postings, contact requests, SMS (text messages), or instant messages.

    1. Don’t publicly display or use the software to share inappropriate content or material (involving, for example, nudity, bestiality, pornography, offensive language, graphic violence, or criminal activity).  

    1. Don’t engage in activity that is fraudulent, false or misleading (e.g., asking for money under false pretenses, impersonating someone else, manipulating the software to increase play count, or affect rankings, ratings, or comments).

    1. Don’t circumvent any restrictions on access to or availability of the software.

    1. Don’t engage in activity that is harmful to you, the software, or others (e.g., transmitting viruses, stalking, posting terrorist content, communicating hate speech, or advocating violence against others).

    1. Don’t infringe upon the rights of others (e.g., unauthorized sharing of copyrighted music or other copyrighted material, resale or other distribution of Bing maps, or photographs).

    1. Don’t engage in activity that violates the privacy of others.

    1. Don’t help others break these rules.
