...
| <a href="#get-social"> <img src="images\icon-get-social.svg" alt="Get social icon" width=100px> </a> <br> [**Get social**](#get-social) <ul> <li>[Finding and making friends](#finding-and-making-friends)</li> <li>[The **People** tab](#the-people-tab)</li> <li>[Taking and sharing selfies and snapshots](#taking-and-sharing-selfies-and-snapshots) </li> <li>[Community standards](#community-standards) </li> </ul> | <a href="#build-events"> <img src="images\icon-build-events.svg" alt="Build events icon" width=100px> </a> <br> [**Build events**](#build-events) <ul> <li> [Create your own event](#create-an-event) </li> </ul>  <a href="#get-help"> <img src="images\icon-get-help.svg" alt="Get help icon" width=100px> </a> <br> [**Get help**](#get-help) |  <a href="#build-worlds"> <img src="images\icon-build-world.svg" alt="Build world icon" width=100px> </a> <br> [**Build Worlds**](#build-worlds) <ul> <li> [Build your own World](#building-your-own-world) </li> </ul> |
