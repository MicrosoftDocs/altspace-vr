...
## If you are trying to launch AltspaceVR for the first time:
...
2. Make sure you have the latest [Oculus Software](https://www.oculus.com/setup) installed, and that Settings-> General-> Unknown Devices is set to ON. If launching in 2D mode, you do not need Oculus installed.
3. Make sure that you have a working internet connection. If you are attempting to launch Altspace from within a network firewall, please open UDP ports 5055 and 5056, as well as TCP ports 80 and 443. If you are within the network of a corporate or educational firewall, you may need to contact the network administrator or IT department.
4. See also:
...
* The version of the application you are using is no longer supported. If you downloaded AltspaceVR through a storefront, the update may have launched very recently before your store was able to update your client.
...
* Remove any objects that may be failing to load by selecting 'Objects' from the left 'World Tools' panel. Problematic objects may include:
    ...
    * Experimental GLTFs.
* After addressing the items above, attempt to re-enter AltspaceVR.