...
5. Set the event to **Private** or **Public**.
    ...
    * Private events aren't visible on the AltspaceVR event calendars and require the event URL to enter the event space.
...
1. **Promote:** Each event requires two branding images (these images appear on the AltspaceVR website and don't appear in your event inside AltspaceVR):
    ...
    * **Banner:** The banner images are required to be 1920x576. This will be resized automatically as necessary and visible on the event information or webpage. A semi-transparent overlay covers the lower 25% of the image. Avoid placing text in that area.
...
2. Select **Upload**.
3. Select **Browse** to open a dialog box on your computer and locate and select the optimized image.
4. Select **Open**.
5. Select **CREATE PHOTO**.
6. Repeat this for all your images.

In AltspaceVR and in the event world, position yourself near where you wish to place the image. (If you're creating this for a **Repeated Use event**, make sure you are in your World and not in the Event space!)
...
7. When the images are set in place, select **Lock All** if you didn't lock them individually, and turn off Edit Mode and close the editor.
8. Only use a maximum of five Photos per event.

## Adding 3D Objects Using World Editor and Kits

AltspaceVR allows importing 3D objects into worlds with the World Editor. There are many World Editors Kits currently available for use, and more on the way. There are spaceships, rockets, animated animals, sculptures, trees, plants, and many different objects. Or you may add your own Kits to the public collection or for your own personal usage, or consider using one of the [AltspaceVR MRE apps](https://docs.microsoft.com/en-us/windows/mixed-reality/altspace-vr/world-building/using-mixed-reality-extensions), which bring interactable objects into your world such as helmets, swords, wings, clothing, hats, or other interactable objects. Expect the list of objects to expand soon.
